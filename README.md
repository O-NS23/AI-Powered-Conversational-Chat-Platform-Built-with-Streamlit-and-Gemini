...
## 📌 Project Flow
1️⃣ User types a question  
2️⃣ Request is sent to Google Gemini  
3️⃣ Gemini processes and generates response  
4️⃣ Chat continues until user ends conversation  
